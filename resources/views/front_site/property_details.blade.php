                ...
                <div class="wrapper row">
                    <div class="preview col-md-6">
                        ...
                        <div class="preview-pic tab-content">
                            ...
                            <div class="tab-pane active" id="pic-1"><img src="{{asset('images/d1.jpg')}}"/></div>
                    ...
                    <div class="details col-md-6">
                        ...
                        <h4 class="price"><span class="ni">price: </span> <span class="sub-span">${{$property->price}}</span></h4>
                        <h4 class="price"><span class="ni">city: </span> <span class="sub-span">{{\App\Models\City::find($property->city_id)->name}}</span></h4>
                        <h4 class="price"><span class="ni">address: </span> <span class="sub-span">{{$property->address}}</span></h4>
                        <h4 class="price"><span class="ni">type: </span> <span class="sub-span">{{\App\Models\Type::find($property->type_id)->name}}</span></h4>
