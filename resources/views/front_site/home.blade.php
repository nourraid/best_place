        ...
        <div class="container py-md-5 py-3">
            <div class="row bottom-ab-grids">
                ...
                <div class="w3ab-left-top col-lg-6 mt-lg-0 mt-5 ps-lg-5">
                    ...
                    <p class="my-3"> This is an introductory video on how to use this site easily and safely, with the aim of facilitating the process of buying, booking and displaying your property </p>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 mt-lg-5 mt-4">
                        <div class="grids-1 box-wrap">
                            ...
                            <h4><a href="#service" class="title-head mb-3">Your One-Stop Shop for Finding Your Dream Property</a></h4>
                        </div>
                    </div>
